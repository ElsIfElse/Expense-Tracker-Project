...
const MainMenu = () => {
    ...
    return (  
        <div className="w-[100vw] h-[100vh] flex flex-col items-center gap-10 p-20 bg-[#A1E3F9] justify-center">
            <div className="grid grid-rows-2 grid-cols-2 aspect-1/1 gap-10 h-[80%]">
